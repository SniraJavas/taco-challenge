    ...
    sendOrder = () => {
        ...
        fetch(BASE_URL + "/api/Orders", {
            ...
            if(results.status == 200 || results.status == 201){
                alert("your order have been sent successfully to be processesd")
            }else{
                alert("your order failed to be processesd ")
            }
            //results.json();
        })
    ...
    render() {
        ...
        return <div class="container">
            ...
            <div class="resturant-container">
                ...
                <button className="order-button" onClick={() => { this.sendOrder() }}>Order R({this.state.totalDetails}) </button>
            </div>
        </div>
    }
}